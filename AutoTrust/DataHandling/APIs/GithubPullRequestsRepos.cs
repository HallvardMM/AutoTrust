...
public class GithubPullRequestsRepos {
  ...
  public static async Task<int?> GetGithubPullRequestsRepos(HttpClient httpClient, string? githubToken, string authorAndProject, string url, bool isDiagnostic) {
    return await DataHandler.FetchGithubHeaderCount(httpClient, githubToken, url, authorAndProject, isDiagnostic,
